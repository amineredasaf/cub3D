...
/*   Updated: 2022/10/24 18:34:57 by rsaf             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_forward(t_data *data)
{
	...
	{
		if (data->map_s.map[(int)floor(y_change / 64)][(int)floor(x_change / 64)] != '0' && data->map_s.map[(int)floor(y_change / 64)][(int)floor(x_change / 64)] != 'S')
			return ;
		mlx_clear_window(data->mlx_s.mlx_ptr, data->mlx_s.win_ptr);
